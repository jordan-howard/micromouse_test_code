/**
  ...
  * @brief          : Hardware configuration program for ST peripherals.
  *
  * This firmware configures the clock for the ST microcontroller. It also 
  * initializes I2C, UART, and GPIO access.
  *
  ******************************************************************************
  * @attention
  *
